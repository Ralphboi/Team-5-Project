...
boat_sprite = pygame.transform.scale(boat_sprite, (32, 32))
boat2_sprite = pygame.image.load('boat2.png')
boat2_sprite = pygame.transform.scale(boat2_sprite, (32, 32))  
boat3_sprite = pygame.image.load('boat3.png')
boat3_sprite = pygame.transform.scale(boat3_sprite, (32, 32))  
boat4_sprite = pygame.image.load('boat4.png')
boat4_sprite = pygame.transform.scale(boat4_sprite, (32, 32)) 
finish_sprite = pygame.image.load('finish.png')
finish_sprite = pygame.transform.scale(finish_sprite, (32, 32))
...
def main():
    global boat_x, boat_y, boat2_x, boat2_y, boat3_x, boat3_y, boat4_x, boat4_y, time_remaining, game_over, laps
